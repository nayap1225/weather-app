  ...
  return (
    <div className="mt-6">
      ...
      {requiredItems.length > 0 ? (
        <div className="mb-6 bg-red-50 p-4 rounded-2xl border border-red-100">
          <h4 className="text-sm font-bold text-red-600 mb-3 flex items-center gap-1.5">
            <span className="bg-red-500 text-white text-[10px] px-1.5 py-0.5 rounded-md font-extrabold tracking-wide">
              MUST
            </span>
            꼭 챙기세요!
          </h4>
            ...
            {requiredItems.map((item) => (
              ...
              >
                <div className="flex justify-between w-full">
                  ...
                  <span className="text-[10px] font-bold text-red-500 bg-red-100 px-1.5 py-0.5 rounded h-fit">
                    필수
                  </span>
                </div>
      ...
      {optionalItems.length > 0 && (
        <div className="px-1">
          <h4 className="text-sm font-bold mb-3 flex items-center gap-1.5 px-2">
            <span className="bg-gray-200 text-gray-600 text-[10px] px-1.5 py-0.5 rounded-md font-bold">
              OPTION
            </span>
            있으면 좋아요
          </h4>
